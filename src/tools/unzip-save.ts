...
const inputFilePath = path.join(__dirname, '../../cli-data/zipped-saves', args.input);
...
const outputFilePath = path.join(__dirname, '../../cli-data/unzipped-saves', outputFilename);
