...
import type { IMainframeHardwareState } from '@state/mainframe-state/states/mainframe-hardware-state/interfaces/mainframe-hardware-state';
import type { IMainframeProgramsState } from '@state/mainframe-state/states/mainframe-programs-state/interfaces/mainframe-programs-state';
