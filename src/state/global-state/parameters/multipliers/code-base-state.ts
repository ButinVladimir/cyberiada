...
import { ICodeBaseState } from '../../interfaces/parameters/multipliers/code-base-state';
import { ICodeBaseSerializedState } from '../../interfaces/serialized-states/multipliers/code-base-serialized-state';
